...
public class IntakeSubsystem {
    ...
    private DcMotor intakeMotor; // Motor controlling the intake
    ...
    public void startIntake() {
        intakeMotor.setPower(1.0); // Set motor power to full
    ...
    public void stopIntake() {
        intakeMotor.setPower(0.0); // Set motor power to 0
    ...
    public void reverseIntake() {
        intakeMotor.setPower(-1.0); // Set motor power to reverse
